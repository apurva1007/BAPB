...
public class UserResourceController {
    ...
    @RequestMapping(value = "/update/{uid}",consumes = APPLICATION_JSON_VALUE ,produces = TEXT_PLAIN_VALUE ,method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/user/{uid}",produces = APPLICATION_JSON_VALUE ,method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/delete/{uid}",produces = TEXT_PLAIN_VALUE ,method = RequestMethod.DELETE)
